    ...
    <section className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-7">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-2">
          <Label className="text-stone-300 text-xs">Start time</Label>
          <Input
            type="time"
            value={startTime}
            onChange={(e) => setStartTime(e.target.value)}
            className="bg-[#34343c] border-white/10 text-stone-100"
          />
        </div>
        <div className="flex flex-col gap-2">
          <Label className="text-stone-300 text-xs">End time</Label>
          <Input
            type="time"
            value={endTime}
